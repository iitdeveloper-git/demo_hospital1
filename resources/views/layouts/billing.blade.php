...
<head>
    ...
    <title>{{ $title ?? 'Billing Command' }} | AarogyaCare</title>
...
<body class="portal-body">
        ...
        <aside class="portal-sidebar" id="portalSidebar">
            ...
            <div class="sidebar-user">
                ...
                <div class="user-info">
                    ...
                    <span class="user-role">Financial Manager</span>
                </div>
            </div>

            <nav class="sidebar-nav">
                <a href="{{ route('billing.dashboard') }}" class="{{ Route::currentRouteName() === 'billing.dashboard' ? 'active' : '' }}">
                    <i class="fa-solid fa-chart-pie"></i><span>Financial Command</span>
                </a>
                <a href="{{ route('billing.packages') }}" class="{{ Route::currentRouteName() === 'billing.packages' ? 'active' : '' }}">
                    <i class="fa-solid fa-cubes"></i><span>Hospital Packages</span>
                </a>
                <a href="{{ route('billing.invoices') }}" class="{{ Route::currentRouteName() === 'billing.invoices' ? 'active' : '' }}">
                    <i class="fa-solid fa-file-invoice"></i><span>Invoices Registry</span>
                </a>
                <a href="{{ route('billing.create') }}" class="{{ Route::currentRouteName() === 'billing.create' ? 'active' : '' }}">
                    <i class="fa-solid fa-file-circle-plus"></i><span>Generate Invoice</span>
                </a>
                <a href="{{ route('billing.payments') }}" class="{{ Route::currentRouteName() === 'billing.payments' ? 'active' : '' }}">
                    <i class="fa-solid fa-cash-register"></i><span>POS Payments Ledger</span>
                </a>
                <a href="{{ route('billing.refunds') }}" class="{{ Route::currentRouteName() === 'billing.refunds' ? 'active' : '' }}">
                    <i class="fa-solid fa-undo"></i><span>Refunds Desk</span>
                </a>
                <a href="{{ route('billing.insurance') }}" class="{{ Route::currentRouteName() === 'billing.insurance' ? 'active' : '' }}">
                    <i class="fa-solid fa-shield-halved"></i><span>Insurance Claims</span>
                </a>
                <a href="{{ route('billing.accounts') }}" class="{{ Route::currentRouteName() === 'billing.accounts' ? 'active' : '' }}">
                    <i class="fa-solid fa-book"></i><span>Journal Ledger</span>
                </a>
                <a href="{{ route('billing.ledgers') }}" class="{{ Route::currentRouteName() === 'billing.ledgers' ? 'active' : '' }}">
                    <i class="fa-solid fa-journal-whills"></i><span>Ledger Accounts</span>
                </a>
                <a href="{{ route('billing.reports') }}" class="{{ Route::currentRouteName() === 'billing.reports' ? 'active' : '' }}">
                    <i class="fa-solid fa-file-contract"></i><span>Revenue Reports</span>
                </a>
                <a href="{{ route('billing.settings') }}" class="{{ Route::currentRouteName() === 'billing.settings' ? 'active' : '' }}">
                    <i class="fa-solid fa-cog"></i><span>Settings</span>
                </a>
            </nav>

            <div class="sidebar-footer">
                <form action="{{ route('billing.logout') }}" method="POST">
                    @csrf
        ...
        <div class="portal-main">
            <header class="portal-topbar">
                <div class="topbar-left">
                    ...
                    <span class="topbar-title">{{ $title ?? 'Billing Command' }}</span>
                </div>
    ...
    <style>
        ...
        /* Generic Helper Styles for Billing Pages */
        .panel {
            background-color: var(--bg-card);
            border: 1px solid var(--border-color);
            border-radius: 16px;
        ...
        .btn-soft:hover { background-color: rgba(99, 102, 241, 0.15); }
        ...
        .status-completed, .status-final, .status-paid, .status-approved { background-color: rgba(16, 185, 129, 0.08); color: #10b981; }
        .status-scheduled, .status-checked-in, .status-pending { background-color: rgba(99, 102, 241, 0.08); color: var(--brand-primary); }
        .status-cancelled, .status-rejected { background-color: rgba(239, 68, 68, 0.08); color: #ef4444; }
