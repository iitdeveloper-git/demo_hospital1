...
<head>
    ...
    <title>{{ $title ?? 'LIMS Command' }} | AarogyaCare</title>
...
<body class="portal-body">
        ...
        <aside class="portal-sidebar" id="portalSidebar">
            ...
            <div class="sidebar-user">
                ...
                <div class="user-info">
                    ...
                    <span class="user-role">Lab Administrator</span>
                </div>
            </div>

            <nav class="sidebar-nav">
                <a href="{{ route('laboratory.dashboard') }}" class="{{ Route::currentRouteName() === 'laboratory.dashboard' ? 'active' : '' }}">
                    <i class="fa-solid fa-chart-pie"></i><span>LIMS Command</span>
                </a>
                <a href="{{ route('laboratory.test-categories') }}" class="{{ Route::currentRouteName() === 'laboratory.test-categories' ? 'active' : '' }}">
                    <i class="fa-solid fa-tags"></i><span>Test Categories</span>
                </a>
                <a href="{{ route('laboratory.tests') }}" class="{{ Route::currentRouteName() === 'laboratory.tests' ? 'active' : '' }}">
                    <i class="fa-solid fa-vials"></i><span>Test Master</span>
                </a>
                <a href="{{ route('laboratory.orders') }}" class="{{ Route::currentRouteName() === 'laboratory.orders' ? 'active' : '' }}">
                    <i class="fa-solid fa-clipboard-list"></i><span>Lab Orders</span>
                </a>
                <a href="{{ route('laboratory.samples') }}" class="{{ Route::currentRouteName() === 'laboratory.samples' ? 'active' : '' }}">
                    <i class="fa-solid fa-box-tissue"></i><span>Sample Tracking</span>
                </a>
                <a href="{{ route('laboratory.reports') }}" class="{{ Route::currentRouteName() === 'laboratory.reports' ? 'active' : '' }}">
                    <i class="fa-solid fa-file-medical-alt"></i><span>Validation Reports</span>
                </a>
                <a href="{{ route('laboratory.equipment') }}" class="{{ Route::currentRouteName() === 'laboratory.equipment' ? 'active' : '' }}">
                    <i class="fa-solid fa-microscope"></i><span>Equipment Logs</span>
                </a>
                <a href="{{ route('laboratory.reagents') }}" class="{{ Route::currentRouteName() === 'laboratory.reagents' ? 'active' : '' }}">
                    <i class="fa-solid fa-prescription-bottle"></i><span>Reagents Stock</span>
                </a>
                <a href="{{ route('laboratory.quality-control') }}" class="{{ Route::currentRouteName() === 'laboratory.quality-control' ? 'active' : '' }}">
                    <i class="fa-solid fa-award"></i><span>Quality Control</span>
                </a>
                <a href="{{ route('laboratory.profile') }}" class="{{ Route::currentRouteName() === 'laboratory.profile' ? 'active' : '' }}">
                    <i class="fa-solid fa-user-md"></i><span>My Profile</span>
                </a>
            </nav>

            <div class="sidebar-footer">
                <form action="{{ route('laboratory.logout') }}" method="POST">
                    @csrf
        ...
        <div class="portal-main">
            <header class="portal-topbar">
                <div class="topbar-left">
                    ...
                    <span class="topbar-title">{{ $title ?? 'LIMS Command' }}</span>
                </div>
    ...
    <style>
        ...
        :root {
            ...
            --brand-hover: #5b21b6;
            --brand-soft: rgba(109, 40, 217, 0.08);
        ...
        [data-theme="dark"] {
            ...
            --sidebar-active-bg: rgba(109, 40, 217, 0.15);
        ...
        /* Generic Helper Styles for LIMS Pages */
        .panel {
            background-color: var(--bg-card);
            border: 1px solid var(--border-color);
            border-radius: 16px;
        ...
        .btn-soft:hover { background-color: rgba(109, 40, 217, 0.15); }
        ...
        .status-completed, .status-final, .status-operational { background-color: rgba(16, 185, 129, 0.08); color: #10b981; }
        .status-scheduled, .status-checked-in, .status-processing { background-color: rgba(109, 40, 217, 0.08); color: var(--brand-primary); }
        .status-cancelled, .status-rejected, .status-down { background-color: rgba(239, 68, 68, 0.08); color: #ef4444; }
