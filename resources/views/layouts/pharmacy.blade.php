...
<head>
    ...
    <title>{{ $title ?? 'Pharmacy ERP' }} | AarogyaCare</title>
...
<body class="portal-body">
    <div class="portal-container" id="portalContainer">
        ...
        <aside class="portal-sidebar" id="portalSidebar">
            ...
            <nav class="sidebar-nav">
                <a href="{{ route('pharmacy.dashboard') }}" class="{{ Route::currentRouteName() === 'pharmacy.dashboard' ? 'active' : '' }}">
                    <i class="fa-solid fa-chart-pie"></i><span>ERP Command</span>
                </a>
                <a href="{{ route('pharmacy.categories') }}" class="{{ Route::currentRouteName() === 'pharmacy.categories' ? 'active' : '' }}">
                    <i class="fa-solid fa-tags"></i><span>Medicine Categories</span>
                </a>
                <a href="{{ route('pharmacy.medicines') }}" class="{{ Route::currentRouteName() === 'pharmacy.medicines' ? 'active' : '' }}">
                    <i class="fa-solid fa-pills"></i><span>Medicines Catalog</span>
                </a>
                <a href="{{ route('pharmacy.prescriptions') }}" class="{{ Route::currentRouteName() === 'pharmacy.prescriptions' ? 'active' : '' }}">
                    <i class="fa-solid fa-prescription"></i><span>Doctor Rx Desk</span>
                </a>
                <a href="{{ route('pharmacy.sales') }}" class="{{ Route::currentRouteName() === 'pharmacy.sales' ? 'active' : '' }}">
                    <i class="fa-solid fa-cart-shopping"></i><span>POS Billing</span>
                </a>
                <a href="{{ route('pharmacy.purchases') }}" class="{{ Route::currentRouteName() === 'pharmacy.purchases' ? 'active' : '' }}">
                    <i class="fa-solid fa-truck-loading"></i><span>Purchase Orders</span>
                </a>
                <a href="{{ route('pharmacy.returns') }}" class="{{ Route::currentRouteName() === 'pharmacy.returns' ? 'active' : '' }}">
                    <i class="fa-solid fa-undo"></i><span>Returns Registry</span>
                </a>
                <a href="{{ route('pharmacy.suppliers') }}" class="{{ Route::currentRouteName() === 'pharmacy.suppliers' ? 'active' : '' }}">
                    <i class="fa-solid fa-truck"></i><span>Suppliers Registry</span>
                </a>
                <a href="{{ route('pharmacy.reports') }}" class="{{ Route::currentRouteName() === 'pharmacy.reports' ? 'active' : '' }}">
                    <i class="fa-solid fa-file-contract"></i><span>Sales Reports</span>
                </a>
                <a href="{{ route('pharmacy.settings') }}" class="{{ Route::currentRouteName() === 'pharmacy.settings' ? 'active' : '' }}">
                    <i class="fa-solid fa-cog"></i><span>ERP Settings</span>
                </a>
            </nav>
        ...
        <div class="portal-main">
            <header class="portal-topbar">
                <div class="topbar-left">
                    ...
                    <span class="topbar-title">{{ $title ?? 'Pharmacy ERP' }}</span>
                </div>
    ...
    <style>
        ...
        /* Generic Helper Styles for Pharmacy Pages */
        .panel {
            background-color: var(--bg-card);
            border: 1px solid var(--border-color);
            border-radius: 16px;
        ...
        .btn-soft:hover { background-color: rgba(16, 185, 129, 0.15); }
        ...
        .status-completed, .status-final, .status-paid, .status-dispensed { background-color: rgba(16, 185, 129, 0.08); color: #10b981; }
        .status-scheduled, .status-checked-in, .status-pending { background-color: rgba(16, 185, 129, 0.08); color: var(--brand-primary); }
