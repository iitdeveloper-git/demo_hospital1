...
<head>
    ...
    <title>{{ $title ?? 'Critical Command' }} | AarogyaCare</title>
...
<body class="portal-body">
        ...
        <aside class="portal-sidebar" id="portalSidebar">
            ...
            <div class="sidebar-user">
                ...
                <div class="user-info">
                    ...
                    <span class="user-role">Trauma Director</span>
                </div>
            </div>

            <nav class="sidebar-nav">
                <a href="{{ route('er.dashboard') }}" class="{{ Route::currentRouteName() === 'er.dashboard' ? 'active' : '' }}">
                    <i class="fa-solid fa-chart-pie"></i><span>Trauma Command</span>
                </a>
                <a href="{{ route('er.patients') }}" class="{{ Route::currentRouteName() === 'er.patients' ? 'active' : '' }}">
                    <i class="fa-solid fa-truck-medical"></i><span>Emergency Queue</span>
                </a>
                <a href="{{ route('er.triage') }}" class="{{ Route::currentRouteName() === 'er.triage' ? 'active' : '' }}">
                    <i class="fa-solid fa-heart-pulse"></i><span>Triage Board</span>
                </a>
                <a href="{{ route('er.ambulance') }}" class="{{ Route::currentRouteName() === 'er.ambulance' ? 'active' : '' }}">
                    <i class="fa-solid fa-ambulance"></i><span>Ambulance fleet</span>
                </a>
                <a href="{{ route('er.icu') }}" class="{{ Route::currentRouteName() === 'er.icu' ? 'active' : '' }}">
                    <i class="fa-solid fa-lungs"></i><span>ICU Monitors</span>
                </a>
                <a href="{{ route('er.beds') }}" class="{{ Route::currentRouteName() === 'er.beds' ? 'active' : '' }}">
                    <i class="fa-solid fa-bed"></i><span>Bed Control</span>
                </a>
                <a href="{{ route('er.operation-theatre') }}" class="{{ Route::currentRouteName() === 'er.operation-theatre' ? 'active' : '' }}">
                    <i class="fa-solid fa-hospital"></i><span>Operation Theatre</span>
                </a>
                <a href="{{ route('er.emergency-alerts') }}" class="{{ Route::currentRouteName() === 'er.emergency-alerts' ? 'active' : '' }}">
                    <i class="fa-solid fa-bell"></i><span>ER Sirens</span>
                </a>
                <a href="{{ route('er.reports') }}" class="{{ Route::currentRouteName() === 'er.reports' ? 'active' : '' }}">
                    <i class="fa-solid fa-file-invoice"></i><span>Response reports</span>
                </a>
            </nav>

            <div class="sidebar-footer">
                <form action="{{ route('er.logout') }}" method="POST">
                    @csrf
        ...
        <div class="portal-main">
            <header class="portal-topbar">
                <div class="topbar-left">
                    ...
                    <span class="topbar-title">{{ $title ?? 'Critical Command' }}</span>
                </div>
    ...
    <style>
        ...
        /* Generic Helper Styles for ER Pages */
        .panel {
            background-color: var(--bg-card);
            border: 1px solid var(--border-color);
            border-radius: 16px;
        ...
        .btn-soft:hover { background-color: rgba(244, 63, 94, 0.15); }
        ...
        .status-completed, .status-final, .status-active, .status-on-time, .status-approved, .status-operational, .status-available, .status-stable { background-color: rgba(16, 185, 129, 0.08); color: #10b981; }
        .status-scheduled, .status-checked-in, .status-pending, .status-triage { background-color: rgba(244, 63, 94, 0.08); color: var(--brand-primary); }
        .status-cancelled, .status-rejected, .status-critical, .status-red { background-color: rgba(239, 68, 68, 0.08); color: #ef4444; }
