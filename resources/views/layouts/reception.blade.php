...
<head>
    ...
    <title>{{ $title ?? 'Front Desk' }} | AarogyaCare</title>
...
<body class="portal-body">
        ...
        <aside class="portal-sidebar" id="portalSidebar">
            ...
            <div class="sidebar-user">
                ...
                <div class="user-info">
                    ...
                    <span class="user-role">Front Desk Executive</span>
                </div>
            </div>

            <nav class="sidebar-nav">
                <a href="{{ route('reception.dashboard') }}" class="{{ Route::currentRouteName() === 'reception.dashboard' ? 'active' : '' }}">
                    <i class="fa-solid fa-chart-pie"></i><span>Desk Dashboard</span>
                </a>
                <a href="{{ route('reception.patients') }}" class="{{ Route::currentRouteName() === 'reception.patients' ? 'active' : '' }}">
                    <i class="fa-solid fa-users"></i><span>Patients Directory</span>
                </a>
                <a href="{{ route('reception.new-patient') }}" class="{{ Route::currentRouteName() === 'reception.new-patient' ? 'active' : '' }}">
                    <i class="fa-solid fa-user-plus"></i><span>New Patient Registration</span>
                </a>
                <a href="{{ route('reception.walk-in') }}" class="{{ Route::currentRouteName() === 'reception.walk-in' ? 'active' : '' }}">
                    <i class="fa-solid fa-notes-medical"></i><span>Book Walk-In</span>
                </a>
                <a href="{{ route('reception.appointments') }}" class="{{ Route::currentRouteName() === 'reception.appointments' ? 'active' : '' }}">
                    <i class="fa-solid fa-calendar-check"></i><span>Appointments Queue</span>
                </a>
                <a href="{{ route('reception.queue') }}" class="{{ Route::currentRouteName() === 'reception.queue' ? 'active' : '' }}">
                    <i class="fa-solid fa-list-ol"></i><span>Live Queue Tokenizer</span>
                </a>
                <a href="{{ route('reception.visitors') }}" class="{{ Route::currentRouteName() === 'reception.visitors' ? 'active' : '' }}">
                    <i class="fa-solid fa-id-badge"></i><span>Visitor Logging</span>
                </a>
                <a href="{{ route('reception.admissions') }}" class="{{ Route::currentRouteName() === 'reception.admissions' ? 'active' : '' }}">
                    <i class="fa-solid fa-bed"></i><span>Bed Admissions</span>
                </a>
                <a href="{{ route('reception.payments') }}" class="{{ Route::currentRouteName() === 'reception.payments' ? 'active' : '' }}">
                    <i class="fa-solid fa-cash-register"></i><span>Payment Receipts</span>
                </a>
                <a href="{{ route('reception.profile') }}" class="{{ Route::currentRouteName() === 'reception.profile' ? 'active' : '' }}">
        ...
        <div class="portal-main">
            <header class="portal-topbar">
                <div class="topbar-left">
                    ...
                    <span class="topbar-title">{{ $title ?? 'Front Desk' }}</span>
                </div>
    ...
    <style>
        ...
        :root {
            ...
            --brand-hover: #0f766e;
            --brand-soft: rgba(13, 148, 136, 0.08);
        ...
        /* Generic Helper Styles for Reception Pages */
        .panel {
            background-color: var(--bg-card);
            border: 1px solid var(--border-color);
            border-radius: 16px;
        ...
        .btn-soft:hover { background-color: rgba(13, 148, 136, 0.15); }
        ...
        .status-completed, .status-paid { background-color: rgba(16, 185, 129, 0.08); color: #10b981; }
        .status-scheduled, .status-checked-in, .status-waiting { background-color: rgba(13, 148, 136, 0.08); color: #0d9488; }
        .status-cancelled, .status-pending { background-color: rgba(239, 68, 68, 0.08); color: #ef4444; }
